  ...
  switch (action.type) {
    ...
    case "withdraw":
      return state.balance > 0
        ? { ...state, balance: state.balance - 75 }
        : state;

    case "requestLoan":
      return state.loan === 0
        ? { ...state, loan: 600, balance: state.balance + 600 }
        : state;
    ...
    <div className="App">
      ...
      <p>
        <button
          ...
          disabled={isActive === false || balance === 0}
        >
          Withdraw 75
        </button>
      </p>
      <p>
        <button
          ...
          disabled={isActive === false || loan > 0}
        >
          Request a loan of 600
        </button>
      </p>
      <p>
        <button
